                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="name" value="{{$price->name}}"  required >
                                </div>
                            </div>                    
                        </div>
                        <div class="col-lg-8">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="number" step="0.01" name="price" value="{{$price->price}}"   required >
                                </div>
                            </div>                    
                        </div>
                        <div class="col-lg-8">
                            <div class="form-group row">
                                <label for="example-text-input" class="col-sm-2 col-form-label text-right">Role Name</label>
                                <div class="col-sm-10">
<select name="role_name" class="form-control" id="">
    @foreach ($roles as $item)
    <option value="{{ $item->name}}" @if($price->role_name == $item->name) selected @endif>{{$item->name}}</option>    
