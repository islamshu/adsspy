            ...
            <div class="page-title-box">
                <div class="float-right">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a >update Product </a></li>
                    </ol>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                         ...
                         <div class="form-group">
                            <img src="{{asset('uploads/'.$product->image)}}"  style="width: 100px" class="img-thumbnail image-preview" data-preview="image" alt="">
                        </div>
                        ...
                        <div class="col-lg-8">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea id="elm1" name="dec">{{$product->dec}}</textarea>
                                </div>
                            </div>                    
                        </div>
