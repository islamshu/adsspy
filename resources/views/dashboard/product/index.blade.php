    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Product Section</h4>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="mt-0 header-title">Product Section</h4>
                    ...
                    <div class="table-responsive">
                        ...
                        <table   class="table table-bordered mb-0 table-centered">
                            ...
                            <tbody >
                                ...
                                <tr>
                                    <td>{{$key +1}}</td>
                                    <td><img src="{{asset('uploads/'.$item->image)}}" width="70" height="70" alt="{{$item->title}}"></td>

                                <td>{{$item->title}}</td>
                                <td><input type="checkbox" data-id="{{ $item->id }}" name="status" class="js-switch" {{ $item->status == 'yes' ? 'checked' : '' }}>
                                </td>
                                <td>                                               
                                    <a href="{{route('product.edit',$item->id)}}" class="mr-2"><i class="fas fa-edit text-info font-16"></i></a>
