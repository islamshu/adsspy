<div class="leftbar-tab-menu">
    <div class="main-icon-menu">
        <a href="{{ route('index.dashboard') }}" class="logo logo-metrica d-block text-center">
            <span>
                <img src="{{ asset('uploads/'.general('logo')) }}" alt="logo-small" class="logo-sm">
            </span>
        </a>
        <nav class="nav">
    ...
    <div class="main-menu-inner">
        ...
        <div class="topbar-left">
            <a href="{{ route('index.dashboard') }}" class="logo">
                <span>
                    <img src="{{ asset('uploads/'.general('logo')) }}" alt="logo-large" class="logo-lg logo-dark">
                    <img src="{{ asset('uploads/'.general('logo')) }}" alt="logo-large" class="logo-lg logo-light">
                </span>
            </a>
        </div>
        <!--end logo-->
