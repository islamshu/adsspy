                            ...
                            <div class="card-body">
                                <div class="px-3">
                                    ...
                                    <div class="text-center auth-logo-text">
                                        <h4 style="visibility: hidden" class="mt-0 mb-3 mt-5">Lets Get Started Metrica</h4>
                                        ...
                                        <div class="form-group row mt-4">
                                            <div class="col-sm-6">
                                                <div class="custom-control custom-switch switch-success">
                                                    <input type="checkbox" class="custom-control-input" id="customSwitchSuccess" name="remember" id="remember" {{ old('remember') ? 'checked' : '' }}>
                                ...
                                <div class="m-3 text-center text-muted">
                                    <p class="">Dont have an account ?  <a href="{{ route('register') }}" class="text-primary ml-2">Free Resister</a></p>
                                </div>
                            </div><!--end card-body-->
                        </div><!--end card-->
