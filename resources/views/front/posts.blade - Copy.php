...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('post_style2/icons/fontawesome-pro-5.14.0/fontawesome-pro-5.14.0/fontawesome-pro-5.14.0-web/css/all.css') }}">

    <link rel="stylesheet" href="{{ asset('post_style2/css/style.css') }}">

    <link rel="stylesheet" href="{{ asset('post_style2/jquery-nice-select-1.1.0/jquery-nice-select-1.1.0/css/nice-select.css') }}">

    <link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/npm/daterangepicker/daterangepicker.css" />

    <link rel="stylesheet" href="{{ asset('post_style2/css/style2.css') }}">
    <script src="{{ asset('post_style2/js/jquery.min.js') }}"></script>
    <script src="{{ asset('post_style2/js/popper.js') }}"></script>
    <script src="{{ asset('post_style2/js/bootstrap.min.js') }}"></script>
    <script src="{{ asset('post_style2/js/moment-with-locales.min.js') }}"></script>
    <script src="{{ asset('post_style2/js/bootstrap-datetimepicker.min.js') }}"></script>
...
<body>
    ...
    <div class="container">
        ...
        <form class="form-inline search my-2 my-lg-0">
            ...
            <input class="form-control mr-sm-2 rounded-0 search-input" type="search" placeholder="Search"
                aria-label="Search">
            <button class="btn btn-outline-info my-2 my-sm-0 rounded-0 search-btn" type="submit">Search</button>
        </form>
    ...
    <div class="panel rounded">
        <div class="container">
            <div class="row">
                <form class="table-responsive-sm">
                    <div class="block-1 ">
                        ...
                        <div class="content countries rounded">
                        ...
                        <select >
                            <option data-display="Post type">Post type</option>
                    ...
                    <div class="block-1">
                        ...
                        <select class="select">
                            <option data-display="affiliate">affiliate</option>
                        ...
                        <ul>
                            <li>
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    ...
                                    <button type="button" class="btn btn-light">90 days</button>
                    ...
                    <div class="block-1 ">
                        ...
                        <select class="select">
                            <option data-display="Last Seen">Last Seen</option>
...
$.ajax(
    ...
    <script src="{{ asset('post_style2/js/main.js') }}"></script>
    
<div  style="display:none">

	<p><img src="https://upload.wikimedia.org/wikipedia/commons/2/29/Loader.gif">Loading More post</p>
